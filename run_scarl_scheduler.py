...
from gym_ds3.schedulers.scarl.data_worker_scarl import SCARLWorker
from gym_ds3.schedulers.scarl.parameter_server import ParameterServer
from config import args
args.scheduler_name = 'scarl'
...
workers = [SCARLWorker.remote(args=args, _id=i) for i in range(args.num_agents)]
